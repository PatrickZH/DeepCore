...
class ContextualDiversity(kCenterGreedy):
    ...
    def construct_matrix(self, index=None):
        ...
        batch_loader = torch.utils.data.DataLoader(self.dst_train if index is None else torch.utils.data.Subset(self.dst_train, index), batch_size=self.args.selection_batch)
