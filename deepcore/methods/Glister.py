...
class Glister(CoresetMethod):
    ...
    def calc_gradient(self, index=None, val=False, record_val_detail=False):
        ...
        for i, (input, targets) in enumerate(batch_loader):
            ...
            with torch.no_grad():
                ...
                weight_parameters_grads = self.network.embedding_recorder.embedding.view(batch_num, 1, self.embedding_dim).repeat(1,
                ...
                if val and record_val_detail:
                    ...
                    self.init_emb.append(self.network.embedding_recorder.embedding)
    ...
    def select(self, **kwargs):
        self.network.embedding_recorder.record_embedding = True
