...
def WideResNet(arch: str, channel: int, num_classes: int, im_size, record_embedding: bool = False,
    ...
    if pretrained:
        ...
        if arch == "wrn502":
            ...
            net = resnet.wide_resnet101_2(pretrained=True)
        else:
        ...
        if arch == "wrn168":
            net = _WideResNet(16, num_classes, channel, 8)
        elif arch == "wrn2810":
            net = _WideResNet(28, num_classes, channel, 10)
        elif arch == "wrn282":
            net = _WideResNet(28, num_classes, channel, 2)
        else:
            raise ValueError("Model architecture not found.")
    else:
